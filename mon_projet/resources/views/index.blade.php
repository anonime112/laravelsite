...
@section('title', 'Iguyzza — Accueil | Lounge & Événements, Abidjan')
...
<!-- Slide1 -->
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url('{{ asset('img/slid1.jpg') }}');">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<p data-appear="fadeInDown" class="caption2-slide1  t-center animated visible-false  m-b-37">
							 Le goût des bons moments
				...
				<div class="item-slick1 item3-slick1" style="background-image: url('{{ asset('img/logo.jpg') }}');">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
...
<div class="ig-orange-band"></div>
				...
				<div class="col-md-6 p-t-45 p-b-30">
					<div class="wrap-text-welcome t-center">
						...
						<h3 class="tit3 t-center m-b-35 m-t-5">
							Un moment mémorable au cœur d'Abidjan
						</h3>

						<p class="t-center m-b-22 size3 m-l-r-auto">
							Que vous célébriez en couple, entre amis, en famille ou pour un événement professionnel, Iguyzza vous accueille à Riviera Palmeraie pour une expérience lounge, gastronomique et festive — restaurant, bar, espace événementiel et service traiteur.
						</p>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="{{ asset('img/espace.jpg') }}" alt="IMG-INTRO"></a>
							</div>
							...
							<div class="wrap-text-blo1 p-t-35">
								...
								<p class="m-b-20">
									Séminaires, anniversaires, mariages et soirées privées dans un cadre élégant à Cocody.
								</p>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="{{ asset('img/bar.jpg') }}" alt="IMG-INTRO"></a>
							</div>
							...
							<div class="wrap-text-blo1 p-t-35">
								...
								<p class="m-b-20">
									Cuisine raffinée, cocktails signature et ambiance lounge pour vos soirées à Abidjan.
								</p>
					...
					<div class="col-md-4 p-t-30">
						...
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
								<a href="#"><img src="{{ asset('img/video.jpg') }}" alt="IMG-INTRO"></a>
							</div>

							<div class="wrap-text-blo1 p-t-35">
								<a href="{{ route('contact') }}"><h4 class="txt5 color0-hov trans-0-4 m-b-13">
									Service traiteur
								</h4></a>

								<p class="m-b-20">
									Repas sur mesure pour vos réceptions, buffets et événements d'entreprise en Côte d'Ivoire.
								</p>
	...
	<!-- Our menu -->
	<section class="section-ourmenu bg2 p-t-115 p-b-120">
		<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="{{ asset('img/dej.jpeg') }}" alt="IMG-MENU">
						...
						<div class="col-sm-6">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="{{ asset('img/diner.png') }}" alt="IMG-MENU">
						...
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="{{ asset('img/upscalemedia-transformed.jpeg') }}" alt="IMG-MENU">
				...
				<div class="col-md-4">
					<div class="row">
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="{{ asset('img/boison1.jpg') }}" alt="IMG-MENU">
						...
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="{{ asset('images/our-menu-11.jpg') }}" alt="IMG-MENU">

								<!-- Button2 -->
								<a href="#" class="btn2 flex-c-m txt5  size3">
									Entrées
								</a>
							</div>
						</div>
						...
						<div class="col-12">
							<!-- Item our menu -->
							<div class="item-ourmenu bo-rad-10 hov-img-zoom pos-relative m-t-30">
								<img src="{{ asset('images/our-menu-18.jpg') }}" alt="IMG-MENU">

								<!-- Button2 -->
								<a href="#" class="btn2 flex-c-m txt5  size4">
									Desserts
								</a>
							</div>
						</div>
	...
	<section class="section-event">
		<div class="wrap-slick2">
			<div class="slick2">
					...
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="zoomIn">
								<!-- Pic block2 -->
								<a href="#" class="wrap-pic-blo2 bg1-blo2" style="background-image: url('{{ asset('img/event2.jpg') }}');">
								...
								<div class="wrap-text-blo2 flex-col-c-m p-l-40 p-r-40 p-t-45 p-b-30">
									<h4 class="tit7 t-center m-b-10">
										Soirées lounge &amp; événements à Iguyzza
									</h4>

									<p class="t-center">
										Retrouvez nos soirées à thème, dégustations et animations dans notre espace de Riviera Palmeraie, Cocody.
									</p>
					...
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="fadeInDown">
								<!-- Pic block2 -->
								<a href="#" class="wrap-pic-blo2 bg2-blo2" style="background-image: url('{{ asset('img/event1.jpg') }}');">
									<div class="time-event size10 txt6 effect1">
				...
				<div class="item-slick2 item3-slick2" style="background-image: url('{{ asset('img/bg1.jpg') }}');">
					<div class="wrap-content-slide2 p-t-115 p-b-208">
						<div class="container">
							<!-- - -->
							<div class="title-event t-center m-b-52">
							...
							<div class="blo2 flex-w flex-str flex-col-c-m-lg animated visible-false" data-appear="rotateInUpLeft">
								<!-- Pic block2 -->
								<a href="#" class="wrap-pic-blo2 bg3-blo2" style="background-image: url('{{ asset('img/bg1.jpg') }}');">
									<div class="time-event size10 txt6 effect1">
										<span class="txt-effect1 flex-c-m">
											08:00 PM Tuesday - 21 November 2018
										</span>
			...
			<div class="row">
				...
				<div class="col-lg-6 p-b-30 p-t-18">
					<div class="wrap-pic-booking size2 bo-rad-10 hov-img-zoom m-l-r-auto">
						<img src="{{ asset('img/table.jpg') }}" alt="IMG-OUR">
					</div>
				</div>
			</div>
		</div>
...
<div class="ig-orange-band"></div>
	...
	<!-- Video -->
	<section class="section-video parallax100" style="background-image: url('{{ asset('img/bg11.jpeg') }}');">
...
<div class="ig-orange-band"></div>
	...
	<section class="section-blog bg-white p-t-115 p-b-123">
		<div class="container">
			<div class="title-section-ourmenu t-center m-b-22">
				<a href="{{ route('home') }}" class="logo-section-wrap m-b-15">
					<img src="{{ asset('images/icons/logo2.png') }}" alt="Iguyzza" class="logo-section logo-section--sm">
				</a>
				<span class="tit2 t-center">
					Actualités
				</span>
			...
			<div class="  blog-scroll-container">
				<div class="col-md-4 p-t-30 blog-scroll-item">
					<!-- Block1 -->
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="{{ route('blog') }}"><img src="{{ asset('img/bg1.jpg') }}" alt="IMG-INTRO"></a>
						...
						<div class="wrap-text-blo1 p-t-35">
							<a href="{{ route('blog') }}"><h4 class="txt5 color0-hov trans-0-4 m-b-13">
								Vendredi : le Brunch des Carnivores
							</h4></a>

							<p class="m-b-20">
								Découvrez l'ambiance Iguyzza : cocktails, musique live et cadre tropical à Riviera Palmeraie.
							</p>
				...
				<div class="col-md-4 p-t-30 blog-scroll-item">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="{{ route('blog') }}"><img src="{{ asset('img/bg2.jpg') }}" alt="IMG-INTRO"></a>
						...
						Samedi :  Karaoke
							...
							<p class="m-b-20">
								Plats signatures, grillades et spécialités pour vos déjeuners et dîners à Cocody.
							</p>
				...
				<div class="col-md-4 p-t-30 blog-scroll-item">
					...
					<div class="blo1">
						<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom pos-relative">
							<a href="{{ route('blog') }}"><img src="{{ asset('img/event1.jpg') }}" alt="IMG-INTRO"></a>
						...
						<div class="wrap-text-blo1 p-t-35">
							<a href="{{ route('blog') }}"><h4 class="txt5 color0-hov trans-0-4 m-b-13">
								Vendredi : Kompa Party
							</h4></a>

							<p class="m-b-20">
								Mariages, anniversaires et réceptions sur mesure avec notre service traiteur Iguyzza.
							</p>
...
@if(isset($events) && $events->isNotEmpty())
					...
					<div class="col-md-4 p-b-30 blog-scroll-item">
						<div class="blo1">
							<div class="wrap-pic-blo1 bo-rad-10 hov-img-zoom">
